import { IWorkspaceProvider, IPathResolver, IToolImplementation, IFileContentReader, IFileContentWriter, IEventBus, IIgnoreManager, IWorkspaceScanner, ICommandExecutor } from '../types.js';
...
export function getTools(
    ...
    return [
        ...
        new RunCommandTool(workspaceProvider, commandExecutor, eventBus)
    ];
}
